...
# mejora sobre semillerio con  14500 envios
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    min_data_in_leaf = c( 100L, 1000L, "integer" )
  )
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-sem3", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-sem3", "DT0001-sem3" )

  DR_drifting_baseline( "DR0001-sem3", "CA0001-sem3" )
  FE_historia_baseline( "FE0001-sem3", "DR0001-sem3" )

  TS_strategy_baseline_202109( "TS0001-sem3", "FE0001-sem3" )

  HT_tuning_baseline( "HT0001-sem3", "TS0001-sem3" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem3", c("HT0001-sem3","TS0001-sem3") )
...
corrida_baseline_semillerio_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_baseline_202107( "TS0002-sem3", "FE0001-sem3" )

  HT_tuning_baseline( "HT0002-sem3", "TS0002-sem3" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-sem3", c("HT0002-sem3","TS0002-sem3") )
