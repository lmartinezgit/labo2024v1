...
corrida_baseline_semillerio_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_baseline_202107( "TS0002-sem2", "FE0001-sem2" )

  HT_tuning_baseline( "HT0002-sem2", "TS0002-sem2" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0002-sem2", c("HT0002-sem2","TS0002-sem2") )
